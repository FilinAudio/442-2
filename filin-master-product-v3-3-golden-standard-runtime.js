  ...
  function installCSS(){
    ...
    s.textContent=`
      ...
      @media(min-width:821px){
        #${ROOT_ID} .v3-pm{width:min(1320px,calc(100% - 136px));margin:28px auto 34px}
        #${ROOT_ID} .v3-pm-toggle{width:60%;margin:0 auto;background:#f0efed} #${ROOT_ID} .v3-pm.open .v3-pm-toggle{width:60%;max-width:none;grid-template-columns:minmax(0,1fr) 38px;margin:0 auto;padding:16px 18px}
        ...
        #${ROOT_ID} .v3-tabs{margin-bottom:24px}
        #${ROOT_ID} .v3-tabs + .v3-divider{display:block!important;margin:12px 0 12px!important}
