/* FILIN LABS — MASTER PRODUCT V5 UNIFIED LOADER V3
   ...
   Purpose:
   - hide legacy Tilda render before first paint
   - select exactly one production pipeline per page group
   - prevent obsolete AMP V4.4/V5/V6/V7 wrappers from running
   - reveal the page only when the selected Golden pipeline is ready
*/
(function(){
'use strict';
if(window.__FILIN_MASTER_PRODUCT_V5_UNIFIED_LOADER_V3__)return;
...
window.__FILIN_MASTER_PRODUCT_V5_UNIFIED_LOADER_V3__=true;
...
function pub(){window.__FILIN_MASTER_PRODUCT_V5_UNIFIED_LOADER_V3_STATE__=JSON.parse(JSON.stringify(state));}
...
function release(){
  ...
  /* compatibility with old speaker prepaint in Site HEAD */
...
var DEP={
  ...
  amp:CDN+'5a656ecf9e6f9df16b35dcdf284012b7773939b3/filin-master-product-v4-production-amp-batch-v3.js'
};
...
/* Fail-open only for CDN/runtime outage; never trap the whole site. */
setTimeout(function(){
