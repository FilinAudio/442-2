/* FILIN LABS — MASTER PRODUCT GOLDEN MATCH V2.4
...
(function () {
  ...
  var STYLE_ID = 'filin-master-golden-match-v24';
...
function hideLegacyGrandTower() {
  ...
  function apply() {
    ...
    document.documentElement.setAttribute('data-fp-golden-match','v2.4');

    console.info(
      '[Master Product V2] GOLDEN MATCH V2.4 APPLIED',
      result
    );
  }

  window.FilinMasterGoldenMatchV24 = Object.freeze({
    version:'2.4',
    apply:apply
  });
...
/* ===== PROVEN PERFECT MATCHES V6.6 — EMBEDDED V2.4 ===== */
(function(){
...
/* ===== GOLDEN BACKUP NATIVE PROMOTIONS V1 — V2.4 ===== */
(function(){
  'use strict';
...
(function () {
  ...
  console.info('[Master Product V2] NATIVE PROMOTIONS V1 / V2.4 READY.');
})();


setTimeout(function(){
  if (window.FilinMasterGoldenMatchV24) {
    window.FilinMasterGoldenMatchV24.apply();
  }
}, 3700);
