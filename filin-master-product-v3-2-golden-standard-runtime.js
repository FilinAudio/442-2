...
(function(){
  ...
  function installCSS(){
    ...
    s.textContent=`
      ...
      #${ROOT_ID} .v3-pm-icon{width:34px;height:34px;display:flex;align-items:center;justify-content:center;border:1px solid #d5b183;border-radius:50%;color:#9c6e39;line-height:1;transition:transform .18s ease} #${ROOT_ID} .v3-pm-icon svg{display:block;width:14px;height:9px;overflow:visible} #${ROOT_ID} .v3-pm-icon path{fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}
      ...
      @media (max-width:${MAX_MOBILE}px){
        ...
        #${ROOT_ID} .v3-commerce{padding:0 16px 0} #${ROOT_ID} .v3-divider{margin:24px 0}
      ...
      @media(min-width:821px){
        ...
        #${ROOT_ID} .v3-tabs + .v3-divider{display:block!important;margin:24px 0 24px!important}
        ...
        #${ROOT_ID} .v3-promotions h2{font-size:23.4px!important;line-height:1.2!important;padding:22px 0 18px!important;font-weight:800!important}
        #${ROOT_ID} .v3-promo-title{min-height:44px;font-size:13px!important;line-height:1.3!important;font-weight:650!important}
        #${ROOT_ID} .v3-promo a{font-size:11.7px!important;line-height:1!important;padding:8px 14px!important;min-width:84px!important}
  ...
  function buildTabs(p,reviewsNode){
    ...
    var bar='<div class="v3-tabbar">'+tabs.map(function(t){return '<button type="button" class="v3-tabbtn" data-tab="'+esc(t.id)+'">'+esc(t.label)+(t.id==='reviews'?' <span class="v3-count">0</span>':'')+'</button>';}).join('')+'</div>';
