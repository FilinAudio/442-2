  ...
  function installCSS(){
    ...
    s.textContent=`
      ...
      @media (max-width:${MAX_MOBILE}px){
        ...
        #fp-v3-hero-back{position:absolute!important;top:138px!important;left:0!important;right:0!important;width:100%!important;max-width:none!important;padding:0 16px!important;color:#fff!important;font-size:14px!important;line-height:1.35!important;font-weight:500!important;text-align:center!important;text-decoration:underline!important;text-underline-offset:3px!important;pointer-events:auto!important;text-shadow:0 2px 8px #000!important}
        ...
        #${ROOT_ID} .v3-tabs{width:calc(100% - 24px);margin:0 12px 26px;padding:0} #${ROOT_ID} .v3-tabbar{display:none} #${ROOT_ID} .v3-panels{padding:0}
      ...
      @media(min-width:821px){
        ...
        #${ROOT_ID} .v3-tabs + .v3-divider{display:none!important}
        #${ROOT_ID} .v3-tabs{margin-bottom:28px}
